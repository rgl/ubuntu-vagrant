...
#       sudo virt-filesystems -a ~/.vagrant.d/boxes/ubuntu-26.04-uefi-amd64/0/libvirt/box.img
#       sudo mkdir /mnt/ubuntu-26.04-uefi-amd64
#       sudo guestmount -a ~/.vagrant.d/boxes/ubuntu-26.04-uefi-amd64/0/libvirt/box.img -m /dev/sda1 --pid-file guestmount.pid --ro /mnt/ubuntu-26.04-uefi-amd64
#       sudo bash -c 'unmkinitramfs /mnt/ubuntu-26.04-uefi-amd64/boot/initrd.img /tmp/ubuntu-26.04-uefi-amd64-initrd' # NB prefer unmkinitramfs over cpio.
#       sudo ls -laF /mnt/ubuntu-26.04-uefi-amd64/var/lib/systemd
#       sudo guestunmount /mnt/ubuntu-26.04-uefi-amd64
